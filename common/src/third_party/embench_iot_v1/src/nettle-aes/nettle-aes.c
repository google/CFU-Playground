...
int
verify_benchmark_nettle_aes (int res __attribute ((unused)))
{
  bool correct = true;
...
void
initialise_benchmark_nettle_aes (void)
{
}


static int benchmark_body_nettle_aes (int  rpt);

void
warm_caches_nettle_aes (int  heat)
{
  benchmark_body_nettle_aes (heat);
...
int
benchmark_nettle_aes (void)
{
  return benchmark_body_nettle_aes (LOCAL_SCALE_FACTOR * CPU_MHZ);
}


static int __attribute__ ((noinline))
benchmark_body_nettle_aes (int rpt)
{
  int i;
