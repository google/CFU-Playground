...
void
initialise_benchmark_crc_32 (void)
{
}


static int benchmark_body_crc_32 (int  rpt);

void
warm_caches_crc_32 (int  heat)
{
  benchmark_body_crc_32 (heat);
...
int
benchmark_crc_32 (void)
{
  return benchmark_body_crc_32 (LOCAL_SCALE_FACTOR * CPU_MHZ);
}


static int __attribute__ ((noinline))
benchmark_body_crc_32 (int rpt)
{
  int i;
  DWORD r;
