...
static int benchmark_body_slre (int  rpt);

void
warm_caches_slre (int  heat)
{
  benchmark_body_slre (heat);
...
benchmark_slre (void)
{
  return benchmark_body_slre (LOCAL_SCALE_FACTOR * CPU_MHZ);
}


static int __attribute__ ((noinline))
benchmark_body_slre (int rpt)
{
  volatile int ret;
  int j;
