...
static int benchmark_body_aha_mont64 (int  rpt);

void
warm_caches_aha_mont64 (int  heat)
{
  benchmark_body_aha_mont64 (heat);
...
int
benchmark_aha_mont64 (void)
{
  return benchmark_body_aha_mont64 (LOCAL_SCALE_FACTOR * CPU_MHZ);
}


static int __attribute__ ((noinline))
benchmark_body_aha_mont64 (int rpt)
{
  int i;
  int errors;
...
void
initialise_benchmark_aha_mont64 (void)
{
...
int
verify_benchmark_aha_mont64 (int r)
{
  return 0 == r;
}
