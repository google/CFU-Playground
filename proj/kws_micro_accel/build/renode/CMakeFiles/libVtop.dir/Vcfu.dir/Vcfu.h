...
VL_MODULE(Vcfu) {
  public:
    ...
    CData/*3:0*/ Cfu__DOT__kws_rcdbpot__DOT__shift;
    IData/*31:0*/ Cfu__DOT__mac_output;
    IData/*31:0*/ Cfu__DOT__rcdbpot_output;
    IData/*31:0*/ Cfu__DOT__kws_mac__DOT__sum_prods;
    IData/*31:0*/ Cfu__DOT__kws_rcdbpot__DOT__mask;
    IData/*31:0*/ Cfu__DOT__kws_rcdbpot__DOT__remainder;
    IData/*31:0*/ Cfu__DOT__kws_rcdbpot__DOT__threshold;
  ...
  public:
    static void _combo__TOP__1(Vcfu__Syms* __restrict vlSymsp);
    static void _combo__TOP__4(Vcfu__Syms* __restrict vlSymsp);
  private:
  ...
  public:
    ...
    static void _sequent__TOP__3(Vcfu__Syms* __restrict vlSymsp);
