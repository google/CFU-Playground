/* C array created from file src/models/micro_speech/model_micro_speech.tflite.*/

const unsigned char model_micro_speech[] = {
...
unsigned int model_micro_speech_len = 18712;