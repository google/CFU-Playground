...
#ifndef TENSORFLOW_LITE_EXPERIMENTAL_MICRO_MNIST_IMAGE_DATA_H_
#define TENSORFLOW_LITE_EXPERIMENTAL_MICRO_MNIST_IMAGE_DATA_H_

#include <cstdint>

extern const int g_mnist_img_data_size;
extern const uint8_t g_mnist_img_data[];
