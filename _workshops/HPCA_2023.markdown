...
To build your own TinyML accelerator and processor during the tutorial, attendees will need to bring a Linux laptop with a USB port and CFU Playground installed. See repo installation directions [here](https://cfu-playground.readthedocs.io/en/latest/setup-guide.html). *We will provide the Lattice FPGAs (Option 4b).*
